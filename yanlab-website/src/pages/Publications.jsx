...
const publications2024 = [
  ...
  },
  {
    ...
    journal: 'ACS Applied Optical Materials doi.org/10.1021/acsaom.4c00103 (2024).'
  },
  {
    number: '243',
  ...
  },
  {
    ...
    journal: 'Nat. Comm. submitted (2024).'
  },
  {
    number: '237',
  ...
  <div className="publications-page">
    <div className="publications-container" style={{
      ...
      <div className="publications-list" style={{ marginTop: '32px' }}>
        {[...publications2025, ...publications2024].map((item) => (
          <div key={item.number} style={{ marginBottom: '18px' }}>
            <div style={{ fontFamily: 'Inter, Arial, sans-serif', fontSize: '1.05rem', color: '#232946', fontWeight: 600, marginBottom: '2px', lineHeight: 1.5 }}>
              {item.number}. "{item.title}"
            </div>
            <div style={{ fontFamily: 'Inter, Arial, sans-serif', color: '#444', fontStyle: 'italic', fontSize: '0.98rem', marginBottom: '2px', lineHeight: 1.5 }}>
              {item.authors}
            </div>
            <div style={{ fontFamily: 'Inter, Arial, sans-serif', color: '#4a90e2', fontWeight: 500, fontSize: '0.98rem', marginBottom: '0px', lineHeight: 1.5 }}>
              {item.journal}
            </div>
          </div>
        ))}
